...
const Home: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const URL_LANGUAGE_AND_KEY ="api_key=680696aacd6dd222b951702b83ddb9e5&language=fr-FR&sort_by=popularity.desc&include_adult=false&include_video=false&page=";
